        ...
        <Card className="w-full max-w-2xl">
          ...
          <CardContent>
            <form onSubmit={handleProfileSetup} className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">GitHub (optional)</label>
                <Input
                  type="text"
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">LinkedIn (optional)</label>
                <Input
                  type="text"
                    ...
                    <div>
                      ...
                      >
                        {profileForm.photo_url ? (
                          ...
                          <div className="p-12 text-center">
                            <div className="flex flex-col items-center gap-4">
                              <div className={`p-4 rounded-full ${isDragging ? 'bg-pink-100' : 'bg-red-100'}`}>
                                <User className={`h-16 w-16 ${isDragging ? 'text-pink-500' : 'text-red-500'}`} />
                              </div>
                              <div>
                                <p className="text-lg font-semibold text-red-600 mb-1">
                                  {isDragging ? 'Drop your photo here!' : '⚠️ Photo Required!'}
                                </p>
                              ...
                              <div className="flex items-center gap-3 w-full max-w-xs">
                                <div className="flex-1 border-t border-gray-300"></div>
                                <span className="text-xs text-gray-500 uppercase">Upload</span>
                                <div className="flex-1 border-t border-gray-300"></div>
                              </div>
                              <label className="cursor-pointer">
                                <div className="px-6 py-3 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg hover:from-red-600 hover:to-pink-600 transition-all shadow-md hover:shadow-lg font-medium">
                                  📸 Choose Your Photo
                                </div>
                                <input
                                  type="file"
                      ...
                      {!profileForm.photo_url && (
                        <div className="mt-3 p-4 bg-red-50 border-2 border-red-300 rounded-lg">
                          <p className="text-sm text-red-700 font-bold flex items-center gap-2">
                            ...
                            IMPORTANT: You must upload your real photo to complete profile setup!
                          </p>
